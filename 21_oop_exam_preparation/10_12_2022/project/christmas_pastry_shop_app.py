...
class ChristmasPastryShopApp:
    ...
    def add_delicacy(self, type_delicacy: str, name: str, price: float):
        same_name = next((d for d in self.delicacies if d.name == name), None)
    ...
    def add_booth(self, type_booth: str, booth_number: int, capacity: int):
        same_number = next((b for b in self.booths if b.booth_number == booth_number), None)
    ...
    def leave_booth(self, booth_number: int):
        ...
        orders_price = sum([d.price for d in booth.delicacy_orders])
        bill = booth.price_for_reservation + orders_price
        self.income += bill
